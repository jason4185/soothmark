...
export function ResultPreview() {
  return (
    <SectionShell
      ...
      description="Soothmark reports highlight the path from AI or fetched web data to state impact and the validation/equivalence mechanism that protects it."
    >
