      ...
      <div className="mx-auto max-w-6xl">
        <section>
          ...
          <p className="mt-4 max-w-3xl text-base leading-7 text-text-muted">
            Explore how Soothmark classifies deterministic contracts, unsafe nondeterministic state writes, fake validation mentions, and protected GenLayer equivalence patterns.
          </p>
          <div className="mt-5 rounded-lg border border-border/80 bg-surface p-4 text-sm leading-6 text-text-muted shadow-[0_16px_44px_rgb(90_70_42_/_0.06)]">
            Soothmark is not a general smart-contract security scanner. These examples focus only on the path from intent to nondeterminism to state impact to verification.
          </div>
        </section>
